...
#[derive(Debug)]
pub struct NeoSynergyProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoSynergyProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoSynergy processing");
    
    let mut processor = NeoSynergyProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoSynergyProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoSynergyProcessor::new(false);
